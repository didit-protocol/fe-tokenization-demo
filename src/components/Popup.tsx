          ...
          <div className="flex flex-col sm:flex-row items-center justify-between">
            ...
            <div className="mt-2 w-full sm:w-auto">
              <button
                ...
                className="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-blue-600 bg-white hover:bg-indigo-50 w-full sm:w-auto"
              >
                Accept
              </button>
            </div>
